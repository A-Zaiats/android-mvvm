...
import io.github.azaiats.androidmvvm.mocks.TestMvvmActivity;
...
public class MvvmActivityTest {
    ...
    public void testOnCreateDelegated() {
        ...
        verify(activity.getMvvmDelegate()).onCreate(null);
    }

    @Test
    @Ignore("robolectric don't return valid isFinished()")
