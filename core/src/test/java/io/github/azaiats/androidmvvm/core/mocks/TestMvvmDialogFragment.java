...
import io.github.azaiats.androidmvvm.core.MvvmDialogFragment;
 ...
 */
public class TestMvvmDialogFragment extends MvvmDialogFragment{

    private MvvmViewModel viewModel = mock(MvvmViewModel.class);
    private FragmentDelegate delegate = mock(FragmentDelegate.class);
    ...
    @Override
    public FragmentDelegate getMvvmDelegate() {
        return delegate;
    }
