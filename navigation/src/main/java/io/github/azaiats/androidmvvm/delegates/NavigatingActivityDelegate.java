...
public class NavigatingActivityDelegate<T extends Navigator, S extends ViewDataBinding,
     ...
     *
     * @param callback           the {@link io.github.azaiats.androidmvvm.delegates.DelegateCallback} for this delegate
     ...
     */
    public NavigatingActivityDelegate(@NonNull DelegateCallback<S, U> callback,
